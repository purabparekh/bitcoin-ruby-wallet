...
MAIN_FILE_NAME = 'wallet.rb'.freeze
...
def show_available_commands
  ...
  puts 'For more details, you can use:' \
       'ruby ' + MAIN_FILE_NAME + ' help <command>'
end
...
def show_help_for_command(command)
  ...
  when 'generatekey'
    ...
    puts '# Parameters:'
    puts '  > compressed: To generate compressed key.' \
          'If not provided, it will create non-compressed key.'
    puts '# Examples:'
  ...
  when 'listutxo'
    ...
    puts 'Lists all the unspent transactions related to your wallet,' \
         'and get the total balance of UTXO'
    puts '# Examples:'
  ...
  when 'sendtoaddress'
    ...
    puts '  > {vout_index}: vout index of above transaction' \
         'that should be spent'
    puts '  > {amount}: Amount to be transferred (in BTC)'
    puts '  > {payee_address}: Address of the payee'
    puts '# Examples:'
    puts '  $ ruby ' + MAIN_FILE_NAME + ' sendtoaddress' \
         'b806a66153863113b21a08cdf46146364040006a8a4b5e070f5bd4b71a81997b ' \
         '1 15 n1V4mwnm1cC42zcxVdcaepnFFSRHyyqPxE'
  ...
  when 'sendtomultisig'
    ...
    puts '  > {vout_index}: vout index of above transaction' \
         'that should be spent'
    puts '  > {amount}: Amount to be transferred (in BTC)'
    puts '  > {min_signatures_required}: Minimum signatures required' \
         'to spend money'
    puts '  > {payee_addresses}: Addresses of the payee, seperated by space'
    puts '# Examples:'
    puts '  $ ruby ' + MAIN_FILE_NAME + ' sendtomultisig ' \
         'b806a66153863113b21a08cdf46146364040006a8a4b5e070f5bd4b71a81997b 1 ' \
         '15 2 n1V4mwnm1cC42zcxVdcaepnFFSRHyyqPxE ' \
         'mjQNsXeN89Pq36jzNjf5BT5W69Qe1NC8f6 n1UezyhE23vES4Vb1wP4QWYxrD6Lbztf2J'
  ...
  when 'redeemtoaddress'
    ...
    puts '  > {payee_address}: Address of the payee'
    puts '# Examples:'
    puts '  $ ruby ' + MAIN_FILE_NAME + ' redeemtoaddress ' \
         'b806a66153863113b21a08cdf46146364040006a8a4b5e070f5bd4b71a81997b ' \
         '1 15 n1V4mwnm1cC42zcxVdcaepnFFSRHyyqPxE'
  else
